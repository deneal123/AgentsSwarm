...
from service.monitoring.metrics import record_session_length, record_session_items_added
...
class RedisSession:
    ...
    def __init__(self, session_id: str, client: Optional[Any] = None, *, ttl_seconds: Optional[int] = None, max_items: Optional[int] = None, prefix: Optional[str] = None):
        try:
            ...
            from service.container import get, RedisClientName
            if client is None:
                client = get(RedisClientName)
        except Exception:
