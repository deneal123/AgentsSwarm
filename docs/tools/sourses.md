...
- [x] [Triton Inference Server (Yolo)](https://docs.ultralytics.com/ru/guides/triton-inference-server/)
- [x] [vLLM Server (Qwen2.5, LLaVA, SmolVLM2)](https://github.com/vllm-project/vllm)
...
- [x] [Eclipse Paho™ MQTT Python Client)](https://github.com/eclipse-paho/paho.mqtt.python)
- [x] [Neo4j](https://neo4j.com/docs/python-manual/current/)
- [x] [PostgreSQL](https://www.geeksforgeeks.org/python/sqlalchemy-tutorial-in-python/)
- [x] [InfluxDB](https://github.com/InfluxCommunity/influxdb3-python)
