...
Async implements a concurrency model, but it is not the only possible one. Multithreading is another option, although asyncio is often easier to implement in an application.
