...
Create a file in /tmp named test-file.txt. To use a different path or filename, modify the value of source_file.

Run file_uploader.py with the following command:
...
Verify the uploaded file with mc ls:
