# GPTHub by InCellCorp (команда «Пришли пить кофе»)

> Платформа единого окна задач для работы с ИИ: чат, агентные маршруты, web/deep-research, генерация файлов, память пользователя и фоновые джобы.
