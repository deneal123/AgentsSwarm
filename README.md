...
- [ ] Двухфазный агент: построение плана из шагов по сложному запросу
- [ ] Замкнутый цикл: выполнение шагов через handoff к специализированным агентам до успеха/остановки/ошибки
- [ ] Стриминг шагов и повторное планирование при проблемах
