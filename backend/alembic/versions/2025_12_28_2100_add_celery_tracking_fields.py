...
down_revision: Union[str, Sequence[str], None] = "1a65587dc2e1"
...
def upgrade() -> None:
    ...
    op.add_column(
        'user_launch',
        sa.Column('celery_task_id', sa.String(length=255), nullable=True, comment='Celery task ID for job tracking'),
        schema='profile'
    )
    ...
    op.add_column(
        'user_launch',
        sa.Column('celery_status', sa.String(length=50), nullable=True, comment='Celery task status'),
        schema='profile'
    )
