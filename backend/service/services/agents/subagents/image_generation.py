...
from service.services.agents.subagents.utils import pick_image_model, pick_text_model
...
class ImageGenerationAgent(BaseSubAgent):
    ...
    async def process(self, user_input: str, context: UserContext) -> AsyncGenerator[AgentEvent, None]:
        ...
        try:
            from service.services.agents.client import create_chat_completion, get_openai_client, list_available_models
