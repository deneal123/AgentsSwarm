...
class RouteModelUseCase:
    async def execute(self, *, text: str, selected_model: str | None, input_type: str | None) -> tuple[str | None, dict[str, Any]]:
...
class RunAgentUseCase:
    async def execute(self, *, processor: AgentProcessor, reply_assembler: ReplyAssembler, metadata: dict[str, Any], **kwargs: Any) -> list[Any]:
        events = []
...
class PostprocessAgentReplyUseCase:
    def execute(self, *, reply_assembler: ReplyAssembler, metadata: dict[str, Any]) -> tuple[str, dict[str, Any]]:
...
class PersistSessionHistoryUseCase:
    def execute(self, *, reply: str, metadata: dict[str, Any], resolved_model: str, reply_assembler: ReplyAssembler, events: list[Any]) -> dict[str, Any]:
        return {
            "reply": reply,
            "metadata": metadata,
