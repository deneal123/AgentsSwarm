...
from service.presentation.routers.memory_api.schemas import (
...
async def get_user_memory(
    ...
    return MemoryFactsResponse(facts=[MemoryFactResponse(**item) for item in facts], context_text=context_text)
