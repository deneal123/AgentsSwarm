...
from service.agents.events import AgentEvent
from service.agents.orchestrator import Orchestrator
from service.agents.pipeline.event_stream import EventSequencer
from service.agents.pipeline import (
    ...
    async def process_message_stream(
        ...
        *,
        ...
        try:
            ...
            # Inject memory + file context into one-shot input (avoid mutating shared agent instructions)
            ...
            # Trigger non-blocking post-response hooks (memory extraction, etc.)
            run_post_response_hooks(
                user_id=user_id,
                thread_id=thread_id,
                user_input=user_input,
